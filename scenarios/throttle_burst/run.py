"""Throttle Burst scenario — 25 rapid-fire intents with tight rate limits.

Demonstrates execution throttle denials (EXEC-001, EXEC-002) and kill
switch trip via violation window accumulation.
"""
...
def main():
    ...
    print(f"Throttle Burst — {summary_dict['total_intents']} intents")
